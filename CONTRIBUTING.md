...
2. Cut a namespaced feature branch from master
  ...
  - doc#x/...
  - refactor#x/...
3. When you've finished with your fix or feature, Rebase new master changes into your branch. submit a [pull request][]
   directly to master. Include a description of your changes.
4. Your pull request will be reviewed by another maintainer. The point of code
...
Your branch should follow this naming convention:
  ...
  - doc#issue/...
  - refactor#x/...
issue being being issue number you're working on
...
git pull
```
you will then switch back to your branch and attempt to rebase these new changes into your code
```bash
